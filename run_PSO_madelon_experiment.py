...
def run_single_experiment(seed, k_vecinos, alpha, pop_size, max_iter, 
    ...
    best_sol_continua, best_fitness, history = run_PSO(**PARAMETROS)
    end_time = time.time()
    ...
    final_results_summary = {
        ...
        'f1_full': f1_full,
        'precision_pso': acc_subset,
        'recall_pso': recall_subset,
        'f1_pso': f1_subset,
        'num_features_pso': num_features_seleccionadas,
        'rd_pso': rd_doa, # Reducción de Dimensionalidad
...
if __name__ == "__main__":
    ...
    RESULTS_DIR = "results_madelon_PSO"
    ...
    for i in range(NUM_RUNS):
        ...
        if i == 0:
            ...
            generate_plots(pd.DataFrame(log_data), plot_results, filename=log_plot_path, algoritmo="pso")
